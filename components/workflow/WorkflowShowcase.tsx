...
export function WorkflowShowcase() {
  ...
  return (
    <div className="flex flex-col gap-5 w-full">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">
              Deterministic headless browser execution with live step telemetry.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-zinc-50 px-2.5 py-1 text-xs font-semibold text-zinc-800">
      ...
      {/* Main View Area: Live Headless Browser Sandbox */}
