...
export const DEFAULT_WORKFLOW_SEEDS: WorkflowBlueprint[] = [
  {
    ...
    description:
      "Connects to target news portal, extracts breaking stories across 5 categories via Browserbase Search & Fetch APIs, synthesizes structured briefings via Gemini, and delivers via email.",
    ...
    nodes: [
      {
        ...
        data: {
          ...
          category: "Navigation",
          badge: "Browser",
          description: "Navigates to the target news site and verifies DOM settlement with anti-bot shielding.",
      ...
      },
      {
        ...
        data: {
          stepNumber: 2,
          title: "Extract 5 Categories Info",
          category: "Search & Fetch",
          badge: "Browserbase API",
          description: "Searches and extracts top articles across 5 news categories (World, Sports, Crime, AI, Politics) using Browserbase Search and Fetch APIs.",
          actionSummary: "Querying Browserbase Search & Fetch APIs across 5 categories",
          url: "https://timesofindia.indiatimes.com/",
          status: "idle",
          metrics: [{ label: "Categories", value: "5 Topics" }, { label: "Engine", value: "Browserbase API" }],
      ...
      },
      {
        ...
        data: {
          ...
          badge: "Gemini 2.5",
          description: "Synthesizes gathered stories into categorized intelligence briefs with heading, subheading, and concise text bullets.",
      ...
      },
      {
        ...
        data: {
          ...
          category: "Delivery",
          badge: "Resend API",
          description: "Compiles styled HTML newsletter briefing and dispatches to recipient inbox via Resend.",
    ...
    edges: [
      { id: "e-news-1-2", source: "news-1", target: "news-2", animated: true, style: { stroke: "#10b981", strokeWidth: 2 } },
      { id: "e-news-2-3", source: "news-2", target: "news-3", animated: true, style: { stroke: "#71717a", strokeWidth: 2 } },
      { id: "e-news-3-4", source: "news-3", target: "news-4", animated: true, style: { stroke: "#71717a", strokeWidth: 2 } },
    ],
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          badge: "Scraper",
          description: "Extracts paper titles, authors, and abstract links from the page.",
    ...
    edges: [
      { id: "e-arxiv-1-2", source: "arxiv-1", target: "arxiv-2", animated: true, style: { stroke: "#10b981", strokeWidth: 2 } },
    ],
  },
  {
